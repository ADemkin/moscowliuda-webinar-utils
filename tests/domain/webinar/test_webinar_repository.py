...
def add_random_webinar(webinar_repo: WebinarRepo) -> Webinar:
    ...
    date_str = "2020-01-01"
    year = 2020
    return webinar_repo.add_webinar(
        url=webinar_url,
        date_str=date_str,
        title=title,
        year=year
...
def test_webinar_repo_add_webinar_gives_webinar_model(webinar_repo: WebinarRepo) -> None:
    webinar_url = "https://webinar-url.some/0/#"
    title = "random webinar title"
    date_str = "2020-01-01"
    year = 2020
    webinar = webinar_repo.add_webinar(
        url=webinar_url,
        date_str=date_str,
        title=title,
        year=year
...
def test_webinar_repo_gives_existing_webinar_by_url(webinar_repo: WebinarRepo) -> None:
