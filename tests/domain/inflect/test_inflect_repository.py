...
class TestInflectRepoName:
    ...
    def test_gives_not_confirmed_name_if_name_is_not_found(
        ...
        inflected = inflect_repo.get_datv_by_name("Антон")
    ...
    def test_gives_confirmed_name_if_name_is_set(
        ...
        inflected = inflect_repo.set_datv_by_name("Антон", "Антону")
        assert inflected.is_confirmed
        inflected_got = inflect_repo.get_datv_by_name("Антон")
    ...
    def test_replaces_name_if_name_already_exists(
        ...
        inflected_incorrect = inflect_repo.set_datv_by_name("Антон", "incorrect")
        assert inflected_incorrect.is_confirmed
        inflected_correct = inflect_repo.set_datv_by_name("Антон", "Антону")
...
class TestInflectRepoFamilyName:
    ...
    def test_gives_not_confirmed_family_name_if_family_name_is_not_found(
        ...
        inflected = inflect_repo.get_datv_by_family_name("Дёмкин")
        assert not inflected.is_confirmed
    ...
    def test_gives_confirmed_family_name_if_family_name_is_set(
        ...
        inflected = inflect_repo.set_datv_by_family_name("Дёмкин", "Дёмкину")
        assert inflected.is_confirmed
        inflected_got = inflect_repo.get_datv_by_family_name("Дёмкин")
        assert inflected == inflected_got
    ...
    def test_replaces_family_name_if_family_name_already_exists(
        ...
        inflected_incorrect = inflect_repo.set_datv_by_family_name("Дёмкин", "incorrect")
        assert inflected_incorrect.is_confirmed
        inflected_correct = inflect_repo.set_datv_by_family_name("Дёмкин", "Дёмкину")
        assert inflected_incorrect != inflected_correct
        assert inflected_correct.is_confirmed
...
class TestInflectRepoFatherName:
    ...
    def test_gives_not_confirmed_father_name_if_father_name_is_not_found(
        ...
        inflected = inflect_repo.get_datv_by_father_name("Андреевна")
        assert not inflected.is_confirmed
    ...
    def test_gives_confirmed_father_name_if_father_name_is_set(
        ...
        inflected = inflect_repo.set_datv_by_father_name("Андреевна", "Андреевне")
        assert inflected.is_confirmed
        inflected_got = inflect_repo.get_datv_by_father_name("Андреевна")
        assert inflected == inflected_got
    ...
    def test_replaces_father_name_if_father_name_already_exists(
        ...
        inflected_incorrect = inflect_repo.set_datv_by_father_name("Андреевна", "incorrect")
        assert inflected_incorrect.is_confirmed
        inflected_correct = inflect_repo.set_datv_by_father_name("Андреевна", "Андреевне")
        assert inflected_incorrect != inflected_correct
        assert inflected_correct.is_confirmed
